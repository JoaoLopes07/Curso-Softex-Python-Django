...
while True:
    ...
    escolha = input(f'Temos os pães: {nome_frances, nome_forma, nome_doce}\nDigite qual você quer: ').lower()
    ...
    if entrega == "2":
        bairro_entrega = input(f'Qual o bairro? (1:{bairro_saojose},2:{bairro_barroco})')
        if bairro_entrega == '1':
    ...
    forma_de_pagamento = input('Escolha a forma de pagamento (1: Dinheiro, 2: Cartão): ')
